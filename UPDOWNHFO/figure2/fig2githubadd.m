% UP/DOWN Max SOZ
clear
load('RONOdataoutphaseMISTAKEv2.mat')
...
for i=1:numel(units)
     [idx1]=find(MDLdata.slowangle>-2.304);
     [idx2]=find(MDLdata.slowangle<-1.885);
     ...
     [idx4]=find(MDLdata.slowangle>1.0472);
     [idx5]=find(MDLdata.slowangle<1.4661);
