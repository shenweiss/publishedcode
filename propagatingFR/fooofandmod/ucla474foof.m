function [edges474, reversed] = ucla474foof(alledges,FRpropertiesVr0306)
...
[idx,~]=find(alledges.patientvector==35);
edges474=alledges(idx,:);
...
for j=1:numel(edges474.patientvector)
    j
    temp=edges474.chnameVector(j);
    if edges474.mean_delay(j)>0
        ch1=temp{1}{1}{1};
        ch2=temp{1}{2}{1};
    else
        ch1=temp{1}{2}{1};
...
edges474 = addvars(edges474,ao_np_aperiodic);
edges474 = addvars(edges474,ao_p_aperiodic);
edges474 = addvars(edges474,ai_np_aperiodic);
edges474 = addvars(edges474,ai_p_aperiodic);
edges474 = addvars(edges474,ao_np_peak);
edges474 = addvars(edges474,ao_p_peak);
edges474 = addvars(edges474,ai_np_peak);
edges474 = addvars(edges474,ai_p_peak);
edges474 = addvars(edges474,ao_np_gauss);
edges474 = addvars(edges474,ao_p_gauss);
edges474 = addvars(edges474,ai_np_gauss);
edges474 = addvars(edges474,ai_p_gauss);
edges474 = addvars(edges474,ao_np_rsqr);
edges474 = addvars(edges474,ao_p_rsqr);
edges474 = addvars(edges474,ai_np_rsqr);
edges474 = addvars(edges474,ai_p_rsqr);

edges474 = addvars(edges474,abo_np_aperiodic);
edges474 = addvars(edges474,abo_p_aperiodic);
edges474 = addvars(edges474,abi_np_aperiodic);
edges474 = addvars(edges474,abi_p_aperiodic);
edges474 = addvars(edges474,abo_np_peak);
edges474 = addvars(edges474,abo_p_peak);
edges474 = addvars(edges474,abi_np_peak);
edges474 = addvars(edges474,abi_p_peak);
edges474 = addvars(edges474,abo_np_gauss);
edges474 = addvars(edges474,abo_p_gauss);
edges474 = addvars(edges474,abi_np_gauss);
edges474 = addvars(edges474,abi_p_gauss);
edges474 = addvars(edges474,abo_np_rsqr);
edges474 = addvars(edges474,abo_p_rsqr);
edges474 = addvars(edges474,abi_np_rsqr);
edges474 = addvars(edges474,abi_p_rsqr);
