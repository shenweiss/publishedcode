function [masterraster,MDLdata]=RONOanalysisBComm(RONOchan,hfo_table)
...
MDLdata=table(bl,hfo,hfodiff,patient,electrode,unit,loc,soz,HFOlevel,power,frequency,preSPIKE,start);
