function [table4145] = tju4145foofind(alledges,FRpropertiesVr0306)

reversed=0;
table4145=[];

[idx,~]=find(alledges.patientvector==4);
edges4145=alledges(idx,:);
...
for j=1:numel(edges4145.patientvector)
    events_out=[];
    j
    temp=edges4145.chnameVector(j);
    if edges4145.mean_delay(j)>0
        ch1=temp{1}{1}{1};
        ch2=temp{1}{2}{1};
    else
        ch1=temp{1}{2}{1};
...
table4145=vertcat(table4145,vtable);
end;
