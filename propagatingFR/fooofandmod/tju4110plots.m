function [edges4110, reversed] = tju4110plots(alledges,FRpropertiesVr0306)
...
edges4110 = addvars(edges4110,ao_np_aperiodic);
edges4110 = addvars(edges4110,ao_p_aperiodic);
edges4110 = addvars(edges4110,ai_np_aperiodic);
edges4110 = addvars(edges4110,ai_p_aperiodic);
edges4110 = addvars(edges4110,ao_np_peak);
edges4110 = addvars(edges4110,ao_p_peak);
edges4110 = addvars(edges4110,ai_np_peak);
edges4110 = addvars(edges4110,ai_p_peak);
edges4110 = addvars(edges4110,ao_np_gauss);
edges4110 = addvars(edges4110,ao_p_gauss);
edges4110 = addvars(edges4110,ai_np_gauss);
edges4110 = addvars(edges4110,ai_p_gauss);
edges4110 = addvars(edges4110,ao_np_rsqr);
edges4110 = addvars(edges4110,ao_p_rsqr);
edges4110 = addvars(edges4110,ai_np_rsqr);
edges4110 = addvars(edges4110,ai_p_rsqr);

edges4110 = addvars(edges4110,abo_np_aperiodic);
edges4110 = addvars(edges4110,abo_p_aperiodic);
edges4110 = addvars(edges4110,abi_np_aperiodic);
edges4110 = addvars(edges4110,abi_p_aperiodic);
edges4110 = addvars(edges4110,abo_np_peak);
edges4110 = addvars(edges4110,abo_p_peak);
edges4110 = addvars(edges4110,abi_np_peak);
edges4110 = addvars(edges4110,abi_p_peak);
edges4110 = addvars(edges4110,abo_np_gauss);
edges4110 = addvars(edges4110,abo_p_gauss);
edges4110 = addvars(edges4110,abi_np_gauss);
edges4110 = addvars(edges4110,abi_p_gauss);
edges4110 = addvars(edges4110,abo_np_rsqr);
edges4110 = addvars(edges4110,abo_p_rsqr);
edges4110 = addvars(edges4110,abi_np_rsqr);
edges4110 = addvars(edges4110,abi_p_rsqr);

figtitle='4110';
save('4110foofexample1.mat','events_in_np', 'events_in_p', 'events_out_np', 'events_out_p')
crossmodulation_mod(events_in_np, events_in_p, events_out_np, events_out_p, figtitle);
