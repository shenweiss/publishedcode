function [edgesIO019, reversed] = tjuIO019foof(alledges,FRpropertiesVr0306)
...
[idx,~]=find(alledges.patientvector==39);
edgesIO019=alledges(idx,:);
...
for j=1:numel(edgesIO019.patientvector)
    j
    temp=edgesIO019.chnameVector(j);
    if edgesIO019.mean_delay(j)>0
        ch1=temp{1}{1}{1};
        ch2=temp{1}{2}{1};
    else
        ch1=temp{1}{2}{1};
...
if reversed==1
    temp=events_out_np;
    temp2=events_out_p;
    events_out_np=events_in_np;
    events_out_p=events_in_p;
    events_in_np=temp;
    events_in_p=temp2;
end;
...
edgesIO019 = addvars(edgesIO019,ao_np_aperiodic);
edgesIO019 = addvars(edgesIO019,ao_p_aperiodic);
edgesIO019 = addvars(edgesIO019,ai_np_aperiodic);
edgesIO019 = addvars(edgesIO019,ai_p_aperiodic);
edgesIO019 = addvars(edgesIO019,ao_np_peak);
edgesIO019 = addvars(edgesIO019,ao_p_peak);
edgesIO019 = addvars(edgesIO019,ai_np_peak);
edgesIO019 = addvars(edgesIO019,ai_p_peak);
edgesIO019 = addvars(edgesIO019,ao_np_gauss);
edgesIO019 = addvars(edgesIO019,ao_p_gauss);
edgesIO019 = addvars(edgesIO019,ai_np_gauss);
edgesIO019 = addvars(edgesIO019,ai_p_gauss);
edgesIO019 = addvars(edgesIO019,ao_np_rsqr);
edgesIO019 = addvars(edgesIO019,ao_p_rsqr);
edgesIO019 = addvars(edgesIO019,ai_np_rsqr);
edgesIO019 = addvars(edgesIO019,ai_p_rsqr);

edgesIO019 = addvars(edgesIO019,abo_np_aperiodic);
edgesIO019 = addvars(edgesIO019,abo_p_aperiodic);
edgesIO019 = addvars(edgesIO019,abi_np_aperiodic);
edgesIO019 = addvars(edgesIO019,abi_p_aperiodic);
edgesIO019 = addvars(edgesIO019,abo_np_peak);
edgesIO019 = addvars(edgesIO019,abo_p_peak);
edgesIO019 = addvars(edgesIO019,abi_np_peak);
edgesIO019 = addvars(edgesIO019,abi_p_peak);
edgesIO019 = addvars(edgesIO019,abo_np_gauss);
edgesIO019 = addvars(edgesIO019,abo_p_gauss);
edgesIO019 = addvars(edgesIO019,abi_np_gauss);
edgesIO019 = addvars(edgesIO019,abi_p_gauss);
edgesIO019 = addvars(edgesIO019,abo_np_rsqr);
edgesIO019 = addvars(edgesIO019,abo_p_rsqr);
edgesIO019 = addvars(edgesIO019,abi_np_rsqr);
edgesIO019 = addvars(edgesIO019,abi_p_rsqr);
