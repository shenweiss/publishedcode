function [edges4163, reversed] = tju4163foof(alledges,FRpropertiesVr0306)
...
[idx,~]=find(alledges.patientvector==5);
edges4163=alledges(idx,:);
...
for j=1:numel(edges4163.patientvector)
    j
    temp=edges4163.chnameVector(j);
    if edges4163.mean_delay(j)>0
        ch1=temp{1}{1}{1};
        ch2=temp{1}{2}{1};
    else
        ch1=temp{1}{2}{1};
...
edges4163 = addvars(edges4163,ao_np_aperiodic);
edges4163 = addvars(edges4163,ao_p_aperiodic);
edges4163 = addvars(edges4163,ai_np_aperiodic);
edges4163 = addvars(edges4163,ai_p_aperiodic);
edges4163 = addvars(edges4163,ao_np_peak);
edges4163 = addvars(edges4163,ao_p_peak);
edges4163 = addvars(edges4163,ai_np_peak);
edges4163 = addvars(edges4163,ai_p_peak);
edges4163 = addvars(edges4163,ao_np_gauss);
edges4163 = addvars(edges4163,ao_p_gauss);
edges4163 = addvars(edges4163,ai_np_gauss);
edges4163 = addvars(edges4163,ai_p_gauss);
edges4163 = addvars(edges4163,ao_np_rsqr);
edges4163 = addvars(edges4163,ao_p_rsqr);
edges4163 = addvars(edges4163,ai_np_rsqr);
edges4163 = addvars(edges4163,ai_p_rsqr);

edges4163 = addvars(edges4163,abo_np_aperiodic);
edges4163 = addvars(edges4163,abo_p_aperiodic);
edges4163 = addvars(edges4163,abi_np_aperiodic);
edges4163 = addvars(edges4163,abi_p_aperiodic);
edges4163 = addvars(edges4163,abo_np_peak);
edges4163 = addvars(edges4163,abo_p_peak);
edges4163 = addvars(edges4163,abi_np_peak);
edges4163 = addvars(edges4163,abi_p_peak);
edges4163 = addvars(edges4163,abo_np_gauss);
edges4163 = addvars(edges4163,abo_p_gauss);
edges4163 = addvars(edges4163,abi_np_gauss);
edges4163 = addvars(edges4163,abi_p_gauss);
edges4163 = addvars(edges4163,abo_np_rsqr);
edges4163 = addvars(edges4163,abo_p_rsqr);
edges4163 = addvars(edges4163,abi_np_rsqr);
edges4163 = addvars(edges4163,abi_p_rsqr);
