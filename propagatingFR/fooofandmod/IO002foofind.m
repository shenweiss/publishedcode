function [tableIO002] = IO002foofind(alledges,FRpropertiesVr0306)

reversed=0;
tableIO002=[];

[idx,~]=find(alledges.patientvector==45);
edgesIO002=alledges(idx,:);
...
for j=1:numel(edgesIO002.patientvector)
    events_out=[];
    j
    temp=edgesIO002.chnameVector(j);
    if edgesIO002.mean_delay(j)>0
        ch1=temp{1}{1}{1};
        ch2=temp{1}{2}{1};
    else
        ch1=temp{1}{2}{1};
...
tableIO002=vertcat(tableIO002,vtable);
end;
