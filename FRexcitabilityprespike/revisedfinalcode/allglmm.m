% R1 simple glmm
glme = fitglme(MDLdata,'hfodiff ~ 1 + preSPIKE + (1|patient) + (1|electrode) + (1|unit)', ... % random effect is by location. No location needed. 
'Distribution','Gaussian','Link','identity','FitMethod','MPL', ...
'DummyVarCoding','effects');

glme = fitglme(MDLdata,'hfodiff ~ 1 + preSPIKE + sumu + preSPIKE:sumu + (1|patient) + (1|electrode) + (1|unit)', ... % random effect is by location. No location needed. 
'Distribution','Gaussian','Link','identity','FitMethod','MPL', ...
'DummyVarCoding','effects');

glme = fitglme(MDLdata,'bl ~ 1 + preSPIKE + (1|patient) + (1|electrode) + (1|unit)', ... % random effect is by location. No location needed. 
'Distribution','Gaussian','Link','identity','FitMethod','MPL', ...
'DummyVarCoding','effects');

glme = fitglme(MDLdata,'hfodiff ~ 1 + preFR + preR + preFR:preR + (1|patient) + (1|electrode) + (1|unit)', ... % random effect is by location. No location needed. 
'Distribution','Gaussian','Link','identity','FitMethod','MPL', ...
'DummyVarCoding','effects');

glme = fitglme(MDLdata,'bl ~ 1 + preFR + preR + preFR:preR + (1|patient) + (1|electrode) + (1|unit)', ... % random effect is by location. No location needed. 
'Distribution','Gaussian','Link','identity','FitMethod','MPL', ...
'DummyVarCoding','effects');
...
glme = fitglme(MDLdata,'hfodiff ~ 1 + power + preFR + preR + power:preFR + power:preR + preFR:preR + power:preFR:preR + (1|patient) + (1|electrode) + (1|unit)', ... % random effect is by location. No location needed. 
'Distribution','Gaussian','Link','identity','FitMethod','MPL', ...
'DummyVarCoding','effects');

glme = fitglme(MDLdata,'bl ~ 1 + power + preFR + preR + power:preFR + power:preR + preFR:preR + power:preFR:preR + (1|patient) + (1|electrode) + (1|unit)', ... % random effect is by location. No location needed. 
'Distribution','Gaussian','Link','identity','FitMethod','MPL', ...
'DummyVarCoding','effects');
